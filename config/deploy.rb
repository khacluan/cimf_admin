...
set :keep_releases, 5
set :application, "Canberra International Music Festival"
set :repository,  "git@github.com:RubifyTechnology/cimf.git"
set :scm, :git
...
namespace :deploy do
  ...
  task :restart, :roles => :web do
    if remote_file_exists?("#{shared_path}/pids/cimf.pid")
      run "kill -s QUIT `cat #{shared_path}/pids/cimf.pid`"
    end
